...
//			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" />';
			  ...
			  * 添加样式-输入框居右
			  */				    
			 sSearchStr==="" ? '<div align="right" style="float:right;"><input type="text" /></div>' : sSearchStr+' <div align="right" style="float:right;"><input type="text" /></div>';

			var nFilter = document.createElement( 'div' );
			nFilter.className = oSettings.oClasses.sFilter;
			/* updated by gongpb
			 * 2013/05/13
			 * label中添加<input type='radio'> 选中search的input
			 * 或者选中其中的一个radio都能选中另外一个radio的问题解决
			 */
//			nFilter.innerHTML = '<label>'+sSearchStr+'</label>';
			nFilter.innerHTML = "<div> "+sSearchStr+"</div>";
